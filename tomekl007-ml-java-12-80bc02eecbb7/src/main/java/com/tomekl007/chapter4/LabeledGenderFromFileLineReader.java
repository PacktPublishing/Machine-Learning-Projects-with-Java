...
public class LabeledGenderFromFileLineReader extends LineRecordReader {
  ...
  // This variable is not used in PredictGenderBasedOnTheName.java
   ...
   */
  public LabeledGenderFromFileLineReader(List<String> labels) {
    this.labels = labels;
